...
const _sfc_main = {
  ...
  methods: {
    trigger(e) {
      common_vendor.index.__f__("log", "at pages/extUI/fab/fab.vue:70", e);
      ...
      common_vendor.index.showModal({
        ...
        success: function(res) {
          if (res.confirm) {
            common_vendor.index.__f__("log", "at pages/extUI/fab/fab.vue:77", "用户点击确定");
          } else if (res.cancel) {
            common_vendor.index.__f__("log", "at pages/extUI/fab/fab.vue:79", "用户点击取消");
          }
        }
      });
    },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.o(($event) => $options.switchBtn("right", "top")),
    h: common_vendor.o((...args) => $options.switchColor && $options.switchColor(...args)),
    i: common_vendor.p({
      title: "基本功能",
      subTitle: "点击按钮,切换 fab 不同状态",
      type: "line"
    }),
    j: common_vendor.sr("fab", "fbc6d2e2-2"),
