  ...
  methods: {
    ...
    getList() {
      ...
      common_vendor.index.request({
        ...
        fail: (data2, code) => {
          common_vendor.index.__f__("log", "at pages/extUI/list/chat.vue:109", "fail" + JSON.stringify(data2));
        }
      });
    },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.f($data.listData, (item, k0, i0) => {
      return {
        a: "f3aa7c8e-10-" + i0 + "," + ("f3aa7c8e-9-" + i0),
        b: item.id,
        c: "f3aa7c8e-9-" + i0 + ",f3aa7c8e-8",
        d: common_vendor.p({
          title: item.author_name,
          avatar: item.cover,
          note: item.title,
