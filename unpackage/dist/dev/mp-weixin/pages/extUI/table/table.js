...
const _sfc_main = {
  ...
  methods: {
    ...
    // 多选
    selectionChange(e) {
      common_vendor.index.__f__("log", "at pages/extUI/table/table.vue:57", e.detail.index);
      this.selectedIndexs = e.detail.index;
    },
    //批量删除
    delTable() {
      common_vendor.index.__f__("log", "at pages/extUI/table/table.vue:62", this.selectedItems());
    },
    // 分页触发
    change(e) {
  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "817b5446-7-" + i0 + "," + ("817b5446-6-" + i0),
        c: common_vendor.t(item.name),
        d: "817b5446-8-" + i0 + "," + ("817b5446-6-" + i0),
        e: common_vendor.t(item.address),
        f: "817b5446-9-" + i0 + "," + ("817b5446-6-" + i0),
        g: "817b5446-10-" + i0 + "," + ("817b5446-6-" + i0),
        h: index,
        i: "817b5446-6-" + i0 + ",817b5446-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "817b5446-0"),
