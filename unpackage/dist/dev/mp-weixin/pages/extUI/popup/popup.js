...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    y: common_vendor.sr("popup", "8c01b9ce-6"),
    ...
    C: common_vendor.sr("message", "8c01b9ce-7"),
    D: common_vendor.p({
      type: "message"
    }),
    ...
    H: common_vendor.sr("alertDialog", "8c01b9ce-9"),
    I: common_vendor.p({
      type: "dialog"
    }),
    J: common_vendor.sr("inputClose", "8c01b9ce-12,8c01b9ce-11"),
    ...
    M: common_vendor.sr("inputDialog", "8c01b9ce-11"),
    N: common_vendor.p({
      type: "dialog"
    }),
    O: common_vendor.sr("share", "8c01b9ce-13"),
    P: common_vendor.p({
      type: "share",
      safeArea: true,
      backgroundColor: "#fff"
