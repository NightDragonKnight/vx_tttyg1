...
const _sfc_main = {
  ...
  methods: {
    ...
    // 抽屉状态发生变化触发
    change(e, type) {
      common_vendor.index.__f__("log", "at pages/extUI/drawer/drawer.vue:67", (type === "showLeft" ? "左窗口" : "右窗口") + (e ? "打开" : "关闭"));
      this[type] = e;
    }
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    d: common_vendor.sr("showLeft", "36758742-2,36758742-1"),
    ...
    l: common_vendor.sr("showRight", "36758742-4,36758742-3"),
