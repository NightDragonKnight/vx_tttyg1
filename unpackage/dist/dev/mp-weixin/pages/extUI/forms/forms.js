...
const _sfc_main = {
  ...
  methods: {
    onClickItem(e) {
      common_vendor.index.__f__("log", "at pages/extUI/forms/forms.vue:293", e);
    ...
    submit(ref) {
      common_vendor.index.__f__("log", "at pages/extUI/forms/forms.vue:312", this.baseFormData);
      this.$refs[ref].validate().then((res) => {
        common_vendor.index.__f__("log", "at pages/extUI/forms/forms.vue:314", "success", res);
        common_vendor.index.showToast({
          title: `校验通过`
        });
      }).catch((err) => {
        common_vendor.index.__f__("log", "at pages/extUI/forms/forms.vue:319", "err", err);
      });
    }
  }
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    A: common_vendor.sr("baseForm", "273798df-2,273798df-1"),
    B: common_vendor.p({
    ...
    L: common_vendor.sr("baseForm", "273798df-21,273798df-19"),
    M: common_vendor.p({
    ...
    X: common_vendor.sr("valiForm", "273798df-27,273798df-26"),
    Y: common_vendor.p({
      rules: $data.rules,
    ...
    ak: common_vendor.sr("customForm", "273798df-35,273798df-34"),
    al: common_vendor.p({
    ...
    ar: common_vendor.f($data.dynamicFormData.domains, (item, index, i0) => {
      return {
        a: "273798df-47-" + i0 + "," + ("273798df-46-" + i0),
    ...
    as: common_vendor.sr("dynamicForm", "273798df-43,273798df-42"),
    at: common_vendor.p({
