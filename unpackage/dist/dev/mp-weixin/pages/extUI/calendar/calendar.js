...
const _sfc_main = {
  ...
  methods: {
    ...
    close() {
      common_vendor.index.__f__("log", "at pages/extUI/calendar/calendar.nvue:102", "弹窗关闭");
    },
    change(e) {
      common_vendor.index.__f__("log", "at pages/extUI/calendar/calendar.nvue:105", "change 返回:", e);
    ...
    confirm(e) {
      common_vendor.index.__f__("log", "at pages/extUI/calendar/calendar.nvue:114", "confirm 返回:", e);
    },
    monthSwitch(e) {
      common_vendor.index.__f__("log", "at pages/extUI/calendar/calendar.nvue:117", "monthSwitchs 返回:", e);
    }
  }
};
if (!Array) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    i: common_vendor.sr("calendar", "684d1b7f-4"),
